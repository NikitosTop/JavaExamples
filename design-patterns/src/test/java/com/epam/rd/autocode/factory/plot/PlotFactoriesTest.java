...
public class PlotFactoriesTest {
    ...
    public void contemporaryDisneyPlotFactory() {
        ...
        assertEquals(
                "Mulan feels a bit awkward and uncomfortable. But personal issues fades, when a big trouble comes - " +
                        "Hun invasion. Mulan stands up against it, but with no success at first.But putting" +
                        " self together and help of friends, including spectacular funny little dragon Mushu " +
                        "restore the spirit and Mulan overcomes the crisis and gains gratitude and respect",
